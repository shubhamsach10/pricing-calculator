  ...
  products: [
      {
        ...
        components: [
          { name: 'Locations', metric: 'Per Location', multiplier: 1.0, varName: 'L' },
          { name: 'Grid Points', metric: 'Per Grid Point', multiplier: 1.0, varName: 'G' },
          { name: 'Frequency', metric: 'Scans per Month', multiplier: 1.0, varName: 'F' },
          { name: 'Base Cost', metric: 'Per Prompt', multiplier: 5.0, varName: 'B' },
          { name: 'Model Premium', metric: 'Additional LLM Cost', multiplier: 10.0, varName: 'M' },
        ],
        useFormula: true,
        formula: '(L * G * F) * (B + M)',
      },
