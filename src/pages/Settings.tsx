    ...
    <div className="space-y-6">
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="mt-1 text-slate-600">Configure global parameters and products</p>
          {isUsingPersonalSettings && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    type="number"
                    step="0.01"
                    value={localSettings.global.pricePerCredit}
                    onChange={(e) => updateGlobal('pricePerCredit', parseFloat(e.target.value))}
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  />
                  <p className="text-xs text-slate-500 mt-1">Fixed price charged per credit</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">
